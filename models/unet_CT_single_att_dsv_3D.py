...
import torch
from .utils_unet import UnetConv3, UnetUp3_CT, UnetGridGatingSignal3, UnetDsv3, init_weights
...
class unet_CT_single_att_dsv_3D(nn.Module):
    ...
    def __init__(self,n_classes=1, feature_scale=4,  is_deconv=True, in_channels=1,
...
if __name__ == "__main__":
    model = unet_CT_single_att_dsv_3D()
